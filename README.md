...
| 4 | [Superstore](https://public.tableau.com/views/SuperstoreReturnRatesStory/SuperstoreReturnRates?:language=en-US&:sid=&:display_count=n&:origin=viz_share_link) | The project task was to review business operations and increase its profitability to avoid bankruptcy. Prepared visualizations using Tableau to report insights. |
